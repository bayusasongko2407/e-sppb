...
stateDiagram-v2
    ...
    WAITING_VERIFICATION_BAT --> REJECTED : Reject
    WAITING_VERIFICATION_BAT --> REVISION_REQUIRED : Request Revision
    WAITING_VERIFICATION_BAT --> WAITING_APPROVAL_MANAGER : Approve
